...
-(void) update:(ccTime)deltaTime {
    ...
    if (background1.position.x < (background1.contentSize.width/2 * -1)) {
        background1.position = ccp((background2.position.x + background2.contentSize.width/2) + background1.contentSize.width/2, background1.contentSize.height/2);
    }
    if (background2.position.x < (background2.contentSize.width/2 * -1)) {
        background2.position = ccp((background1.position.x + background1.contentSize.width/2) + background2.contentSize.width/2, background2.contentSize.height/2);
    }
...
- (void) monkeyDead {
    ...
    [[CCDirector sharedDirector] replaceScene:[[GameOverScene alloc] initWithScore:(int64_t)_distance]];
}
